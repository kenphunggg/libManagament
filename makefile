...
SOURCES = src/main.cpp src/storage.cpp src/logger.cpp src/session/1_add_new_book.cpp src/session/2_view_all.cpp src/session/3_search_book.cpp src/session/4_issue_book.cpp src/session/5_return_book.cpp
